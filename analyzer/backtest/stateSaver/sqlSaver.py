...
from analyzer.backtest.constant import (
    ...
    STATE_SAVER_PLACED_ORDERS,
    STATE_SAVER_ACCOUNT,
    STATE_SAVER_METRICS_START_DATE,
    STATE_SAVER_METRICS_END_DATE,
    STATE_SAVER_METRICS_HIGHEST_VALUE,
    STATE_SAVER_METRICS_LOWEST_VALUE,
    STATE_SAVER_METRICS_SHARPE_RATIO,
    STATE_SAVER_METRICS_MAX_DRAW_DOWN,
    STATE_SAVER_METRICS_R_SQUARED,
)
